...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      ><Text style = {{color :'red', textAlign:'center',  marginTop:10, fontWeight:'bold', fontSize:40}}>Birthday Wishes</Text></TouchableOpacity>	
   ...
   <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','Happy Birthday Dear May this Day bring to you alot of happiness')}
      ...
      style={{width: 128, height: 128, marginTop:5}}
       ...
       <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','Special wishes for the special person on special day happy Birthday')}
      ...
      style={{width: 128, height: 128, marginTop:5}}
        ...
        <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','Wishing you a day that is as special in every way as you are!')}
      style={{backgroundColor:'lavender',height:100,width:300, marginTop:5,}}
   ...
   <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','My Mother is a walking Mircale, Happy mothers day Mom')}
   ...
   <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','Mama was my greatest teacher, a teacher of compassion, love and fearlessness')}
      style={{backgroundColor:'skyblue',height:100,width:360, marginTop:10,}}
   ...
   <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','I remember my mothers prayers and they have always followed me. Happy Mothers day')}
      style={{backgroundColor:'violet',height:100,width:300, marginTop:10,}}
 ...
 <TouchableOpacity onPress={() => Communications.textWithoutEncoding(' ','You are the only only relation in my life that i made own my choice , Happy Friendship day')}
      style={{backgroundColor:'skyblue',height:100,width:360, marginTop:10,}}
      ><Text style = {{color :'blue', textAlign:'center',  marginTop:10, fontWeight:'bold', fontSize:25}}>You are the only only relation in my life that i made own my choice , Happy Friendship day</Text></TouchableOpacity>
